"""weapon_pack 的 CLI 规划、生成、验证与逐资产导出闭环。"""
...
def test_weapon_pack_plan_create_and_export_each_asset_by_id(
    examples_dir: Path,
    tmp_path: Path,
    ...
    pack_path = examples_dir / "weapon_pack.yaml"
    ...
    assert payload["pack_type"] == "weapon_pack"
